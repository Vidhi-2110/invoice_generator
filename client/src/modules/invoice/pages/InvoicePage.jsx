      ...
      {!showForm && (
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3 self-start sm:self-auto">
            <ExportButton type="invoices" label="Export .xlsx" />
            <button
              onClick={() => setShowForm(true)}
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-sm font-semibold text-white shadow-md shadow-indigo-600/10 active:scale-95 transition-all shrink-0"
            >
              <FiPlus size={16} />
