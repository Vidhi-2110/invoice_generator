    ...
    <div className="max-w-4xl mx-auto space-y-6 print:p-0 print:shadow-none print:max-w-full">
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl shadow-md overflow-hidden print:shadow-sm print:rounded-2xl print:border print:border-slate-200/80 print:break-inside-avoid">
        ...
        <div className="p-8 md:p-12 space-y-6 md:space-y-8 print:p-8 print:py-6 print:space-y-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 print:gap-4">
            ...
            <div className="space-y-2 max-w-sm text-xs font-medium text-slate-700 leading-snug print:space-y-1">
              <div className="mb-3 print:mb-1.5">
                <img
                  src={logoImg}
                  alt="Futentia Logo"
                  className="h-11 print:h-9 w-auto object-contain"
                  onError={(e) => {
              ...
              {company.address && <p className="text-slate-600 pt-1 leading-normal print:pt-0.5">{company.address}</p>}
            </div>
            ...
            <div className="text-left md:text-right space-y-2 print:space-y-1">
              <div className="inline-block border-b-2 border-[#0B65C6] pb-1">
                <h1 className="text-2xl md:text-3xl font-extrabold text-[#0B65C6] uppercase tracking-wide print:text-2xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 print:gap-4">
            ...
            <div className="w-full md:w-72 space-y-1.5 text-xs font-medium text-slate-700 print:space-y-1">
              ...
              <div className="flex justify-between items-center pt-2 border-t border-slate-200">
                ...
                <span className="text-xl md:text-2xl font-black text-[#0B65C6]">
          ...
          <div className="border-t border-slate-200/80 pt-4 print:pt-2"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 print:gap-4 items-end">
            ...
            <div className="space-y-1.5 print:space-y-1">
              <h3 className="text-xs font-bold text-[#0B65C6] pb-0.5 border-b border-slate-200 inline-block uppercase tracking-wider">
                Bank Details
              </h3>
            ...
            <div className="text-left md:text-right space-y-1 print:space-y-0.5">
              ...
              <p className="text-[11px] font-semibold text-slate-800">For Futentia Solutions Pvt. Ltd.</p>
              ...
              <div className="relative h-24 print:h-20 w-64 ml-0 md:ml-auto flex items-center justify-center my-1 overflow-visible">
                ...
                <img
                  ...
                  className="h-24 print:h-20 w-24 print:w-20 absolute right-10 top-0 opacity-80 mix-blend-multiply pointer-events-none object-contain"
                />
                ...
                <img
                  src={jaySignature}
                  alt="Jay Signature"
                  className="h-24 print:h-20 w-52 print:w-44 z-10 absolute right-0 top-0 opacity-100 mix-blend-multiply pointer-events-none object-contain scale-125 origin-right"
                />
              </div>
        ...
        {/* Bottom Banner */}
        <div className="bg-[#0B65C6] py-2.5 print:py-2 text-center text-white text-xs print:text-[11px] font-bold tracking-wider uppercase mt-auto">
